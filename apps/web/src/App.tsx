...
import { AdminCustomerContactsPage, AdminDashboardPage, AdminLoadTestsPage, AdminPartsPage, AdminPriceJobsPage, AdminTicketDetailPage, AdminTicketsPage, AgentSessionAdminPage, RagEvidenceAdminPage, ToolInvocationAdminPage } from './features/admin/AdminPages';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/customer-contacts" element={<RequireAdmin><AdminCustomerContactsPage /></RequireAdmin>} />
