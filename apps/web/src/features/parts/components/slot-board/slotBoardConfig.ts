...
export const SLOT_CONFIGS: SlotConfig[] = [
  { category: 'CPU', label: 'CPU', glyph: '/slot-board/parts/cpu.svg', layout: { x: 3, y: 4, w: 28, h: 26 } },
  { category: 'RAM', label: 'RAM', glyph: '/slot-board/parts/ram.svg', miniSlots: 4, miniFillBy: 'quantity', layout: { x: 36, y: 4, w: 28, h: 26 } },
  { category: 'STORAGE', label: 'SSD', glyph: '/slot-board/parts/ssd.svg', miniSlots: 2, miniFillBy: 'items', layout: { x: 69, y: 4, w: 28, h: 26 } },
  { category: 'GPU', label: 'GPU', glyph: '/slot-board/parts/gpu.svg', layout: { x: 3, y: 37, w: 28, h: 26 } },
  { category: 'MOTHERBOARD', label: '메인보드', glyph: '/slot-board/parts/motherboard.svg', layout: { x: 36, y: 37, w: 28, h: 26 } },
  { category: 'COOLER', label: '쿨러', glyph: '/slot-board/parts/cooler.svg', layout: { x: 69, y: 37, w: 28, h: 26 } },
  { category: 'PSU', label: '파워', glyph: '/slot-board/parts/psu.svg', layout: { x: 3, y: 70, w: 28, h: 26 } },
  { category: 'CASE', label: '케이스', glyph: '/slot-board/parts/case.svg', layout: { x: 36, y: 70, w: 28, h: 26 } }
];
