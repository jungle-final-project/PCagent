...
const WARNING_STATUSES = new Set(['WARN', 'MEDIUM', 'OPEN', 'REQUESTED', 'ADMIN_REVIEWING', 'SCHEDULED', 'LINK_SENT', 'SESSION_STARTED', 'VISIT_IN_PROGRESS', 'REQUIRED', 'NEEDS_MORE_INFO', 'MONITOR_ONLY']);
const DANGER_STATUSES = new Set(['FAIL', 'LOW', 'REJECTED', 'CANCELLED', 'VISIT_REQUIRED', 'REPAIR_OR_REPLACE', 'UNSUPPORTED']);
